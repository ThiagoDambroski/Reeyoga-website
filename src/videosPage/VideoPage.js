  ...
  const videosArray = [
    {
      ...
      videoId: 'Ptavpleb47o',
      videoTitle: 'Yôga no alto da sé',
      videoDescrption: "Com uma vista majestosa da cidade de Olinda estendendo-se ao fundo, este vídeo oferece uma experiência única que combina posturas desafiadoras com profunda serenidade, criando um ambiente propício para o equilíbrio e bem-estar."+
      "\n\nCada movimento é cuidadosamente orientado para ajudá-lo a se conectar com o seu eu interior, permitindo-lhe respirar profundamente e mergulhar dentro de si fazendo fluir e encontrar dentro de você um tesouro incrivél. Mais do que uma simples prática , este é um convite para uma jornada de autodescoberta que eleva não apenas o seu corpo, mas também a sua alma." +
      "\n\nEste vídeo se desenrola em um local verdadeiramente mágico, onde o yôga se encontra com o céu, proporcionando uma sensação de paz e harmonia que transcende o comum. Prepare-se para uma experiência transcendental que nutre não apenas o seu corpo, mas também a sua mente e espírito, enquanto você se entrega a esta prática única."

    },
    {
      backgroundColor: '#c0b3cb',
      videoId: 'tKu02R_dJlo',
      videoTitle: 'Yôga no alto da sé 2',
